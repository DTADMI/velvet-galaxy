---
name: brand-copy-velvet
description: Review Velvet Galaxy user-facing copy, VG-specific naming, tone, terminology consistency, and UI text across all surfaces. Use when a task changes labels, helper text, toasts, alerts, emails, or product naming in Velvet Galaxy.
---

# Brand Copy Velvet

Use this skill for brand language quality and naming consistency in Velvet Galaxy.

## Workflow

1. Determine the surface: public landing, auth, social feed, messaging, marketplace, admin, or email.
...
- Prefer direct, clear wording over cleverness.
- Keep UI text consistent across components that share the same function.
- Verify that new copy does not conflict with existing naming conventions.
